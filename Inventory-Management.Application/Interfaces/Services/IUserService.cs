...
public interface IUserService
{
    ...
    Task<PagedResponse<UserDto>> GetPagedAsync(int page, int pageSize, string? search, string? tenantId, string? orderBy, bool descending, CancellationToken cancellationToken = default);
