...
public interface IAuthService
{
    ...
    Task ForgotPasswordAsync(ForgotPasswordRequestDto request, string clientUri);
    Task<(bool Success, IEnumerable<string>? Errors)> ResetPasswordAsync(ResetPasswordRequestDto request);
}
